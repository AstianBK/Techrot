...
public class BioCrafterTileBlock extends TileEntity implements ITickable, ISidedInventory {
    public int currentNutrient = 0;
    private NonNullList<ItemStack> container = NonNullList.<ItemStack>withSize(10, ItemStack.EMPTY);
