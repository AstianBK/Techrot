...
public class BioCrafterBlock extends BlockTileBase{
    public static final PropertyDirection FACING = BlockHorizontal.FACING;

    public BioCrafterBlock(Material material, String name) {
        super(material, name);
    }
    @Nullable
    @Override
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new BioCrafterTileBlock();
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        else
        {
            ...
            if (tileentity instanceof BioCrafterTileBlock) {
                playerIn.openGui(Techrot.main,4,worldIn,pos.getX(),pos.getY(),pos.getZ());
