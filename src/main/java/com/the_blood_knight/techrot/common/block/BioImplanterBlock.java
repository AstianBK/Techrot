...
public class BioImplanterBlock extends BlockTileBase{
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    private static boolean keepInventory;
    private final boolean active;
    public BioImplanterBlock(Material material, String name, boolean active) {
        super(material, name);
    ...
    {
        return new BioImplanterTileBlock();
    }
