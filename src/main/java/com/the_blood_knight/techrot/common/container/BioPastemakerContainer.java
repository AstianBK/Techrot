...
public class BioPastemakerContainer extends Container {
    ...
    public BioPastemakerContainer(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        ...
        this.addSlotToContainer(new Slot(furnaceInventory, 1, 56 + 18, 35));

        this.addSlotToContainer(new Slot(furnaceInventory, 2, 56 + 36, 35));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (index != 1 && index != 0 && index != 2)
            {
                ...
                else if (index >= 30 && index < 40 && !this.mergeItemStack(itemstack1, 4, 31, false))
                {
                    return ItemStack.EMPTY;
                }
            }
